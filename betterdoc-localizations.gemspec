...
Gem::Specification.new do |spec|
  spec.name        = "betterdoc-localizations"
  spec.version     = File.read(File.expand_path("BETTERDOC_LOCALIZATIONS_VERSION", __dir__)).strip
  spec.authors     = ["BetterDoc GmbH"]
  spec.email       = ["development@betterdoc.de"]
  spec.homepage    = "http://www.betterdoc.de"
  spec.summary     = "Commonly used localizations"
  spec.license     = "MIT"
